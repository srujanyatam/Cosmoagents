...
import type { ConversionResult, CodeFile, ConversionIssue, DataTypeMapping, ConversionPerformance } from '@/types';
...
export const generateBalancedPerformanceMetrics = (
    ...
    const recommendations = generateRecommendations(convertedCode, performanceScore);
    ...
    return {
        ...
        recommendations,
        scalabilityMetrics: {
            bulkOperationsUsed: convertedCode.includes('FORALL'),
...
export const generateBalancedConversionReport = (results: ConversionResult[]): string => {
